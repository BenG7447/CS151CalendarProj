...
public class CalendarView implements ChangeListener 
{
    ...
    private ViewLayout viewLayout; //shows different formats based on day, week, month
	...
	{
		for (int x = 0; x < mock.getDayInWeek(1) - 1; x++) 
		{
	 ...
	 * @param m CalendarMock model that stores and manipulates data of calendar
	 */
	...
	{ 
		...
		monthButton.addActionListener( new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				monthView(LocalDate.of(mock.getCurrentYear(), 
												mock.getCurrentMonth() + 1, 
														mock.getCurrentlySelectedDay()));
				prev.setEnabled(true);
				next.setEnabled(true);
			}
		});
		...
		weekButton.addActionListener( new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				prev.setEnabled(true);
				next.setEnabled(true);
				weekView(LocalDate.of(mock.getCurrentYear(), 
													mock.getCurrentMonth() + 1, 
														mock.getCurrentlySelectedDay()));
			}
		});
		...
		dayButton.addActionListener( new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				prev.setEnabled(true);
				next.setEnabled(true);
				dayView(LocalDate.of(mock.getCurrentYear(), 
											mock.getCurrentMonth() + 1, 
												mock.getCurrentlySelectedDay()));
			}
		});
		...
		{
			@Override
			public void actionPerformed(ActionEvent e){ mock.previousMonth(); }
		});
		...
		{
			@Override
			public void actionPerformed(ActionEvent e){ mock.nextMonth(); }
		});
		...
		nameOfMonth.setText("" + months[mock.getCurrentMonth()] + 
														" " + mock.getCurrentYear());
		...
		submit.addActionListener( new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				else 
				{
                    ...
                    else if (!timeConflict && mock.getCurrentYear() 
                    			== dayOfEvent[2] && mock.getCurrentMonth() + 1 
                    				== dayOfEvent[0] && mock.getCurrentlySelectedDay() 
                    					== dayOfEvent[1])
	...
	{  
		LocalDate d = LocalDate.of(mock.getCurrentYear(), 
											mock.getCurrentMonth() + 1, i);
		curerntDayOfView = d;
	...
	{
		if ( mock.monthStateChanged() 
				|| mock.getChangeInDisplay() 
					|| mock.getChangeInSelectedDay()) 
		{ 
	 ...
	 * @param vl ViewLayout
	 */
    public void setViewLayout(ViewLayout vl){ this.viewLayout = vl; }
